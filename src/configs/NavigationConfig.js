  ...
  submenu: [
    ...
    ,{
      ...
      submenu: [
        ...
        {
          key: 'apps-master-hsn',
          path: `${APP_PREFIX_PATH}/apps/master/hsn`,
          title: 'sidenav.apps.master.hsn',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
        {
          key: 'apps-master-country',
          path: `${APP_PREFIX_PATH}/apps/master/country`,
          title: 'sidenav.apps.master.country',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
